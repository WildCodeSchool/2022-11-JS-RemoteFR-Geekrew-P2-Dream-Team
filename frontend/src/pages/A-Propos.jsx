    ...
    <>
      <div className="mx-5 mb-10 md:mb-20 z-10 flex flex-col md:justify-evenly md:mx-20">
        <title className="flex justify-around items-end my-4 md:my-8">
          <h1 className="font-cinzel md:text-8xl text-4xl  text-white">
            Oniriq
          </h1>
        ...
        <div className="font-sans text-white text-left flex flex-col xl:mx-20">
          ...
          <p className="text-lg md:text-xl">
            Les rêves s’effacent rapidement. Seulement 5 minutes après le
            réveil, 50% du souvenir d’un rêve serait perdu. Après 10 minutes,
            90% du rêve aurait disparu. Oniriq est la solution!
          </p>
          <Staff />
        </div>
      </div>
